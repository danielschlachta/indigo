...
class idg_view_html_renderer_navigation extends idg_view_node_obj
{
	...
	function render(&$document, &$view)
	{
		...
		$css = "div#$idg_id-box { position: fixed; " 
			. "right: 30px; width: 248px; top: 160px; font-size: 63%;" 
			. " $font_blocks color: $fg_col; z-index: 210; }\n" 
		...
		$css_ie = "div#$idg_id-box { position: absolute;" 
			. " width: 250px; right: 46px;  }\n" 
			. "div#$idg_id-content { width: 228px; }\n" 
			. "div#$idg_id-content ul { padding: 0 2px 0 2px; }\n";
